...
export default function AppGateway() {
  ...
  return (
    <div className="min-h-screen bg-[#121212] font-sans selection:bg-[#CD7F32]/30 text-white relative overflow-hidden">
      ...
      {/* =========================================================================
          1. MOBILE / NATIVE APK DIRECT LOGIN PORTAL
          Visible on mobile/tablet (< 768px) OR when running inside Capacitor APK.
          Shows: First Logo perfectly fitted in box -> Login Form -> Direct Dashboard.
         ========================================================================= */}
      <div className={isNativeApp ? "block w-full min-h-screen flex flex-col justify-between p-4 sm:p-6" : "md:hidden w-full min-h-screen flex flex-col justify-between p-4 sm:p-6"}>
        ...
        <main className="relative z-10 my-auto py-6 flex items-center justify-center w-full">
          <motion.div 
            initial={{ opacity: 0, y: 15 }}
            animate={{ opacity: 1, y: 0 }}
            className="w-full max-w-sm sm:max-w-md bg-[#1a1a1a]/95 backdrop-blur-2xl rounded-3xl shadow-2xl shadow-black/80 border-2 border-[#CD7F32]/50 p-6 sm:p-8 relative overflow-hidden"
          >
            ...
            {error && (
              <motion.div 
                ...
                animate={{ opacity: 1, scale: 1 }}
                className="bg-red-500/15 border border-red-500/30 text-red-400 text-xs px-3.5 py-2.5 rounded-xl mb-5 flex items-center gap-2 text-left"
              >
            ...
            {requires2FA ? (
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-[11px] font-bold uppercase tracking-wider text-gray-400 mb-1.5 font-mono">Email Address</label>
                  <div className="relative">
                    <Mail className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 pointer-events-none" />
                    <input 
                      type="email" 
                      required
                      className="w-full bg-black/60 border border-white/20 rounded-xl pl-10 pr-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:border-[#CD7F32] focus:ring-1 focus:ring-[#CD7F32] transition-all text-sm font-medium"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      required
                      className="w-full bg-black/60 border border-white/20 rounded-xl pl-10 pr-10 py-3 text-white placeholder-gray-600 focus:outline-none focus:border-[#CD7F32] focus:ring-1 focus:ring-[#CD7F32] transition-all text-sm font-medium"
                      placeholder="••••••••••••"
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-[#CD7F32] to-[#b06a29] hover:from-[#b06a29] hover:to-[#965820] text-white rounded-xl py-3.5 font-bold shadow-lg shadow-[#CD7F32]/25 mt-2 disabled:opacity-50 flex items-center justify-center gap-2 transition-all active:scale-[0.98] text-sm"
                >
                  {loginLoading ? (
                    <span className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin" />
                  ) : (
                ...
                <a
                  ...
                  className="w-full bg-[#242424] hover:bg-[#2a2a2a] border border-white/15 text-white rounded-xl py-3 font-bold shadow-md flex items-center justify-center gap-2.5 transition-all active:scale-[0.98] text-xs"
                >
        ...
        <footer className="relative z-10 text-center py-2 border-t border-white/5 text-[11px] text-gray-500 flex flex-wrap justify-center gap-x-4 gap-y-1">
          <span>&copy; {new Date().getFullYear()} BackStage App Portal</span>

  ...
  return (
    <div className="min-h-screen bg-[#F5F5DC] flex">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-[#242424] border-t-2 border-[#CD7F32] z-50 flex items-center justify-around pb-safe h-16 px-1 shadow-[0_-4px_10px_rgba(0,0,0,0.3)]">
        ...
        {/* Overflow Menu (Profile/Runners) */}
        <Link href="/worker/profile" className={`flex flex-col items-center justify-center w-full h-full ${pathname?.startsWith('/worker/profile') ? 'text-[#CD7F32]' : 'text-white/60 hover:text-white'}`}>
          <div className="mb-1">

        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[60] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="bg-[#111111] p-8 pb-12 text-center relative overflow-hidden">
              ...
              <div className={`flex items-center gap-2.5 ${"text-2xl font-bold font-serif text-white mb-1 tracking-wide"}`}><img src="/logo.jpg" alt="Logo" className="w-14 h-14 object-contain drop-shadow-md" /><h2>Back <span className="text-[#CD7F32]">Stage</span></h2></div>

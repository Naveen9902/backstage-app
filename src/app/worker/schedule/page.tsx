                  ...
                  return (
                    <div key={app.id} className="bg-gray-50 rounded-2xl p-5 border border-gray-100 relative overflow-hidden">
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        {/* Payment & Rating Logic for Closed Events */}
                        {isClosed && (
                          <div className="flex flex-col gap-3 mt-2">
                            {app.status !== 'PAID' ? (
                              <button
                                ...
                                className="w-full bg-green-600 hover:bg-green-700 text-white px-4 py-3 rounded-xl font-bold flex items-center justify-center gap-2 transition-colors shadow-sm"
                              >
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                                Confirm Payment Received
                              </button>
                            ) : (
                              <div className="bg-indigo-50 text-indigo-700 border border-indigo-200 px-4 py-3 rounded-xl flex items-center justify-center gap-2 font-bold w-full">
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[60] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="bg-[#111111] p-8 pb-12 text-center relative overflow-hidden">
              ...
              <div className={`flex items-center gap-2.5 ${"text-2xl font-bold font-serif text-white mb-1 tracking-wide"}`}><img src="/logo.jpg" alt="Logo" className="w-24 h-24 object-contain drop-shadow-md" /><h2>Back <span className="text-[#CD7F32]">Stage</span></h2></div>

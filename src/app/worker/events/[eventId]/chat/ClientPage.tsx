...
export default function WorkerEventChatPage({ params }: { params: Promise<{ eventId: string }> }) {
      ...
      try {
        ...
        if (scheduleRes.ok) {
          ...
          if (Array.isArray(schedule)) {
            const isAccepted = schedule.some((app: any) => app.staffingRequest?.eventId === eventId);
            setHasPermission(isAccepted);
          }
        }
      } catch (e) {
        console.error(e);

...
export default function ProfilePage() {
  ...
  const handleDeleteAccount = async () => {
    if (!window.confirm("DANGER: Are you sure you want to permanently delete your account? This action cannot be undone and all data will be permanently wiped.")) {
      return;
    }
    setDeleting(true);
    try {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-3 mt-8 mb-12 p-8 bg-[#111111] border border-[#CD7F32]/50 rounded-[2rem] w-full shadow-2xl relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <p className="text-[#EAE6DF] text-sm mb-6 font-medium max-w-2xl">Permanently delete your Back Stage account, including all your community interactions, messages, and profile data. This action cannot be undone and all data will be permanently wiped.</p>
            <button onClick={handleDeleteAccount} disabled={deleting} className="px-8 py-3 bg-gradient-to-r from-[#CD7F32] to-[#a86524] text-black font-black rounded-xl hover:scale-[1.02] transition-transform duration-300 shadow-[0_0_15px_rgba(205,127,50,0.5)] disabled:opacity-50 flex items-center gap-2">

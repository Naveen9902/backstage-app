...
import UserDashboardEvents from '@/components/UserDashboardEvents';

export default function UserDashboard() {
  return (
    <div className="space-y-10 text-[#242424] font-sans">
      <div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Link href="/user/events">
          <motion.div 
            ...
            className="bg-white rounded-2xl p-6 shadow-sm border border-[#CD7F32]/20 cursor-pointer h-full flex flex-col justify-between hover:border-[#CD7F32]/50 transition-all"
          >
            <div>
            ...
            <span className="text-xs font-bold text-[#CD7F32] mt-4 block">View Events Page →</span>
          </motion.div>
        </Link>
        ...
        <Link href="/user/community">
          ...
          >
            ...
            <span className="text-xs font-bold text-[#CD7F32] mt-4 block">Open Community Hub →</span>
          </motion.div>
        </Link>
      </div>

      {/* Embedded Interactive Events & Communities Portal */}
      <UserDashboardEvents />
    </div>
  );
}

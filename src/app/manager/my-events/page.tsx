    ...
    <div className="relative text-[#242424] min-h-screen pb-24 overflow-hidden">
      ...
      {eventToDelete && (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
          ...
          >
            <h2 className="text-xl font-bold font-serif mb-4 text-gray-900">Delete Event?</h2>
            <p className="text-gray-500 text-sm mb-6">Are you sure you want to delete &quot;{eventToDelete.title}&quot;? This action cannot be undone.</p>
            <div className="flex gap-3 w-full">
              <button
                onClick={() => setEventToDelete(null)}
                disabled={toggling === eventToDelete.id + '_delete'}
              ...
              <button
                ...
                disabled={toggling === eventToDelete.id + '_delete'}
                className="flex-1 py-2.5 rounded-xl text-sm font-bold bg-red-500 text-white hover:bg-red-600 transition-colors flex justify-center items-center gap-2"
              >
                {toggling === eventToDelete.id + '_delete' ? (
                  <>

          ...
          {requires2FA ? (
            <div className="space-y-5">
              <div className="text-center mb-6">
                <p className="text-[#F5F5DC]/80 text-sm">Enter the 6-digit code from your authenticator app to continue.</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-[#F5F5DC]/80 mb-1.5">Authentication Code</label>
                <input 
                  type="text" 
                  maxLength={6}
                  className="w-full bg-black/30 border border-white/10 rounded-xl px-4 py-3 text-[#F5F5DC] placeholder-[#F5F5DC]/30 focus:outline-none focus:border-[#CD7F32] focus:ring-1 focus:ring-[#CD7F32] transition-all text-center tracking-[0.5em] text-lg font-mono"
                  placeholder="000000"
                  value={otpCode}
            ...
            <div className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <Link href="/forgot-password" className="text-xs text-[#CD7F32] hover:underline">Forgot password?</Link>
                </div>
